...
def main() -> int:
    ...
    parser.add_argument("--penwidth_max", action="store", type=int, default=5, help="Default: 5")
    parser.add_argument("--arrowsize_min", action="store", type=int, default=1, help="Default: 1")
    parser.add_argument("--arrowsize_max", action="store", type=int, default=2, help="Default: 2")
    parser.add_argument("--weight_min", action="store", type=int, default=1, help="Default: 1")
    parser.add_argument("--weight_max", action="store", type=int, default=100, help="Default: 100")
